...
public class SDImageCache extends NSObject {
	...
	@Generated
	@Selector("config")
	public native SDImageCacheConfig config();
	...
	@Generated
	@Selector("diskImageDataExistsWithKey:")
	public native boolean diskImageDataExistsWithKey(String key);
	...
	@Generated
	@Selector("queryCacheOperationForKey:options:done:")
	public native NSOperation queryCacheOperationForKeyOptionsDone(
			String key,
			@NUInt long options,
			@ObjCBlock(name = "call_queryCacheOperationForKeyOptionsDone") Block_queryCacheOperationForKeyOptionsDone doneBlock);

	@Runtime(ObjCRuntime.class)
	@Generated
	public interface Block_queryCacheOperationForKeyOptionsDone {
		@Generated
		void call_queryCacheOperationForKeyOptionsDone(UIImage arg0,
				NSData arg1, @NInt long arg2);
	}
