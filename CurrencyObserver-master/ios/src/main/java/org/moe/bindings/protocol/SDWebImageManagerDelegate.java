...
public interface SDWebImageManagerDelegate {
	@Generated
	@IsOptional
	@Selector("imageManager:shouldBlockFailedURL:withError:")
	default boolean imageManagerShouldBlockFailedURLWithError(
			SDWebImageManager imageManager, NSURL imageURL, NSError error) {
